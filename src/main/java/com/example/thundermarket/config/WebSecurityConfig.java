package com.example.thundermarket.config;

import com.example.thundermarket.exception.ExceptionHandlerFilter;
import com.example.thundermarket.jwt.JwtAuthFilter;
...
//        jwt필터와 필터예외처리필터 2개 생성
        http.authorizeRequests().antMatchers("/signup/**").permitAll()
                ...
                .antMatchers(HttpMethod.POST,"/products/image").permitAll()
